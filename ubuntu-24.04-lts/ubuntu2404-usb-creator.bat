@echo off
echo ============================================
echo Ubuntu 24.04 LTS Autoinstall USB Creator
echo ============================================
echo.
...
echo This script helps prepare Ubuntu 24.04 LTS autoinstall files.
echo.
echo Prerequisites:
echo 1. Rufus (https://rufus.ie/)
echo 2. Ubuntu 24.04 LTS Server ISO (https://ubuntu.com/download/server)
...
if exist "%SCRIPT_DIR%ubuntu2404-user-data" (
    echo [OK] ubuntu2404-user-data found
) else (
    echo [ERROR] ubuntu2404-user-data not found in current directory
    pause
    exit /b
)

if exist "%SCRIPT_DIR%ubuntu2404-meta-data" (
    echo [OK] ubuntu2404-meta-data found
) else (
    echo [ERROR] ubuntu2404-meta-data not found in current directory
    pause
    exit /b
)
...
echo    - Select Ubuntu 24.04 LTS Server ISO
...
copy "%SCRIPT_DIR%ubuntu2404-user-data" "%USB_DRIVE%\autoinstall\user-data"
if %errorLevel% equ 0 (
...
copy "%SCRIPT_DIR%ubuntu2404-meta-data" "%USB_DRIVE%\autoinstall\meta-data"
if %errorLevel% equ 0 (
...
if exist "%SCRIPT_DIR%ubuntu2404-grub.cfg" (
    copy "%SCRIPT_DIR%ubuntu2404-grub.cfg" "%USB_DRIVE%\boot\grub\grub.cfg"
    echo [OK] Replaced grub.cfg with Ubuntu 24.04 autoinstall version
) else (
    echo [WARNING] ubuntu2404-grub.cfg not found
...
echo.
echo ============================================
echo UBUNTU 24.04 LTS USB PREPARATION COMPLETE!
echo ============================================
echo.
echo Your Ubuntu 24.04 LTS autoinstall USB is ready.
echo.
echo Files on USB:
...
echo.
echo Ubuntu 24.04 LTS Details:
echo - Latest LTS release (April 2024)
echo - Supported until April 2029
echo - Kernel 6.8 - Best new hardware support
echo - Python 3.12
echo.
echo Next steps:
